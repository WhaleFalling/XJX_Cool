...
router.post("/create", (req, res) => {
    const $sql = `INSERT INTO admin_access (access_name,node_type,parent_id,url,remark) VALUES(?,?,?,?,?)`;
...
router.post("/update", (req, res) => {
    const $sql = `UPDATE admin_access SET access_name=?,node_type=?,parent_id=?,url=?,remark=? WHERE access_id=?`
